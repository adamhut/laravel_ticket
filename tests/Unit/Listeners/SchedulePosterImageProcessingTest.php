...
class SchedulePosterImageProcessingTest extends TestCase
{
	use RefreshDatabase;
	/** @test */
	public function it_queses_a_job_to_process_a_poster_image_if_a_poster_image_is_present()
	{
	...
	/** @test */
	public function a_job_is_not_queue_if_poster_image_is_not_present()
	{
		Queue::fake();
